...
DBconnection DBConn = new DBconnection();
	...
	public boolean CheckLogin(java.sql.Connection conn, String s1, String s2) throws SQLException {
	...
	public String Page(String sPage, java.sql.ResultSet rs, int intPage, int intPageSize) {
		StringBuffer sb = new StringBuffer();
		String s = null;
	...
	public String PageFront(String sPage, java.sql.ResultSet rs, int intPage,int intPageSize) {
		StringBuffer sb = new StringBuffer();
		String s = null;
	...
	public boolean AddLog(String[] s) {
		try {
			java.sql.Connection Conn = this.DBConn.getConn();
			java.sql.Statement stmt = Conn.createStatement(1004, 1007);
			ResultSet rs = null;
			for (int i = 0; i < s.length; i++) {
